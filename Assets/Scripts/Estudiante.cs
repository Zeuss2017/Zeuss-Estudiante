...
public class Estudiante{
    ...
    public Estudiante()
    {
		...
		ActividadEstudiante a1 = new ActividadEstudiante( 0  , 0 , 0f , 1 , false , 1 , 1);
		ActividadEstudiante a2 = new ActividadEstudiante( 0  , 0 , 0f , 1 , false , 2 , 1);
		ActividadEstudiante a3 = new ActividadEstudiante( 0  , 0 , 0f , 1 , false , 3  , 1);
